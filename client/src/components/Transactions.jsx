...
const TransactionsCard = ({ addressTo, addressFrom, timestamp, message, keyword, amount, url }) => {
  ...
  return (
    <div className="bg-[#c4ace3] m-4 flex flex-1 border
      2xl:min-w-[450px]
      2xl:max-w-[500px]
      sm:min-w-[270px]
      sm:max-w-[300px]
    ...
    >
      <div className="flex flex-col items-center w-full mt-3">
        ...
        />
        <div className="bg-[#000000] p-3 px-5 w-max rounded-3xl -mt-5 shadow-2xl">
          <p className="text-[#99cc99] font-bold">{timestamp}</p>
        </div>
      </div>
    </div>
  );
